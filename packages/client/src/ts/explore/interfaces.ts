...
//------------------------- Data models 
export type SearchResultHandler = (input:IActionParameters,output:IActionResult)=>void;
//-------------------------------------
...
//-------------------------------------
   ...
   */
  publish( res:ResourceType, action:ActionType, parameters:IActionParameters ): Promise<IActionResult>;
