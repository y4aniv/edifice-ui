import { ACTION, GetContextParameters, GetContextResult, GetResourcesParameters, GetResourcesResult, IContext, ID, CreateFolderParameters, CreateFolderResult, RESOURCE } from "../../../src/interfaces";
